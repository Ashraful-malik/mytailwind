        ...
        <div class="pl-4 h-screen overflow-y-auto pt-4">
          ...
          <div class="">
            ...
            <input
              ...
              v-model="selected_values.badge_text"
            ...
            <div class="flex gap-3 w-full flex-wrap text-sm mt-4 items-center">
              ...
              >
                <div
                  :class="backgroundColor.color"
                  class="p-3 rounded-full cursor-pointer border-gray-400"
                  @click="getNotificationIconColor(backgroundColor.color)"
                  v-on:click="sendChange"
                ></div>
              </div>
              <div class="color_selector flex items-center">
                <button
                  ...
                  class="bg-blue-500 px-3 py-1 text-white rounded-full flex items-center content-center text-center"
                  @click="
                    () => getNotificationPopup('notificationColorTrigger')
                  "
                  v-on:click="sendChange"
                >
                  <p class="text-center">More Colors</p>
                ...
                <!-- sending data in bgColor popup component-->
                <bgColorPopup
                  v-if="popupTriggers.notificationColorTrigger"
                  :getNotificationPopup="
                    () => getNotificationPopup('notificationColorTrigger')
                  "
                  :background-color="colors"
                  v-on:notification-bg-color="getNotificationIconColor($event)"
                />
              </div>
            </div>
          </div>
...
export default {
  ...
  setup() {
    const popupTriggers = ref({
      ...
      notificationColorTrigger: false,
    });
    ...
    const getNotificationPopup = (trigger) => {
      popupTriggers.value[trigger] = !popupTriggers.value[trigger];
    };
  ...
  data() {
    return {
      ...
      selected_values: {
        ...
        font_size: "text-2xl",
        font_width: "font-semibold",
        box_shadow: "",
        border_width: "",
        border_color: "",
        notification_icon_color: "bg-red-500",
      },
  ...
  methods: {
    sendChange() {
      this.$emit("badge-values", this.selected_values);
    },
    getTextColor(value) {
    ...
    getNotificationIconColor(value) {
      this.selected_values.notification_icon_color = value;
    },
  },
  mounted() {
    try {
