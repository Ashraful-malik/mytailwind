      ...
      <div class="flex flex-row bg-gray-800 container_height">
        ...
        >
          ...
          <div class="flex items-center justify-center p-4 w-full h-4/5">
            <footer
              class="footer-container w-full flex items-center justify-center px-4 flex-col"
              :class="[
            ...
            >
              <div
                class="social-icon flex items-center mt-8 w-48 justify-around"
              ...
              <div class="links mb-8" :class="[value.width, value.margin_top]">
    ...
    async copyCode(value) {
      try {
        ...
        <footer
              ...
              ${value.background_color} ${value.border_radius} ${value.height}">
              <div
                class="social-icon flex items-center mt-8 w-48 justify-around 
                ${value.icon_color}">
                <div class="twitter">
              ...
              <div class="links mb-8 ${value.width} ${value.margin_top}">
                <ul class="flex items-end justify-between">
                  <li
                    class="
                      ${value.text_color}
